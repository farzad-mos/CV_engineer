...
- **Preprocessing**:
  - Assumes drone images are resized to 224x224 and normalized to [0,1] (standard for MobileNetV3, check [here](https://github.com/farzad-mos/CV_engineer/tree/main/2_System_design/preprocessing/lat_lon_conv) for how to convert latitude and longtitude coordinates to nomralized [0,1] values).
